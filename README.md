...
## Logger
Logger is used to parse diffrent type of scanners log.
The scanners produce logs in diffrent format so then our logegr need to read the diffrent format.
Logs are olso send in diffrent way and our logger transforme the result from the scanners into our way of logging.

Tags to be added to the logs are

### Settings 
These values will be added to the logs
